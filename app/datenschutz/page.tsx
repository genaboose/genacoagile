...
export const metadata = {
  title: "Datenschutz – GENACO Agile",
  description: "Datenschutzerklärung für die Website der GENACO Agile.",
};

export default function DatenschutzPage() {
  const content = String.raw`Datenschutzerklärung
Diese Datenschutzerklärung klärt Sie über die Art, den Umfang und Zweck der Verarbeitung von personenbezogenen Daten (nachfolgend kurz „Daten“) innerhalb unseres Onlineangebotes und der mit ihm verbundenen Webseiten, Funktionen und Inhalte sowie externen Onlinepräsenzen, wie z.B. unser Social Media Profile auf (nachfolgend gemeinsam bezeichnet als „Onlineangebot“). Im Hinblick auf die verwendeten Begrifflichkeiten, wie z.B. „Verarbeitung“ oder „Verantwortlicher“ verweisen wir auf die Definitionen im Art. 4 der Datenschutzgrundverordnung (DSGVO).

Verantwortlicher
GENACO UG (Haftungsbeschränkt)
Kinderlehre 14
67677 Enkenbach-Alsenborn
Deutschland
Tel +49 6303 999 5045
Mail info@genaco.de
Geschäftsführer/ Inhaber: Emma Nauerz (Anschrift wie oben)
Link zum Impressum: https://www.genacoagile.de/impressum
...
CRM-System Hotjar
Wir setzen das CRM-System „Hotjar“, des Anbieters Hotjar Ltd., Level 2, St. Julians Business Centre, 3 Elia Zammit Street, St. Julians STJ 1000, MALTA ein, um Anfragen der Nutzer schneller und effizienter bearbeiten zu können (berechtigtes Interesse gem. Art. 6 Abs. 1 lit. f. DSGVO ).
...
Wenn Nutzer mit einer Datenerhebung über und einer Datenspeicherung im externen System von Hotjar nicht einverstanden sind, bieten wir ihnen alternative Kontaktmöglichkeiten zur Einreichung von Service-Anfragen per E-Mail, Telefon, Telefax oder Post.

Weitere Informationen erhalten die Nutzer in der Datenschutzerklärung von Hotjar: https://www.hotjar.com/legal/compliance/gdpr-commitment. Der Dienstleister wird auf Grundlage unserer berechtigten Interessen gem. Art. 6 Abs. 1 lit. f DSGVO und eines Auftragsverarbeitungsvertrages gem. Art. 28 Abs. 3 S. 1 DSGVO eingesetzt.
  ...
  return (
    <div className="min-h-screen bg-white text-slate-900">
      ...
      <main className="max-w-5xl mx-auto px-4 py-10">
        <h1 className="text-3xl md:text-4xl font-extrabold tracking-tight">Datenschutzerklärung</h1>
        <p className="mt-2 text-sm text-slate-500">Stand: {new Date().toLocaleDateString("de-DE")}</p>

        {/* Policy Text */}
        <article className="mt-6 whitespace-pre-wrap text-[15px] leading-7 text-slate-800">
          {content}
        </article>
      </main>
    </div>
